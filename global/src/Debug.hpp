 ...
 */
    ...
    #define PRINT_VARIABLES(var1,var2) std::cout << "DEBUG: " #var1 " = " << var1 << ", " \
        #var2 " = " << var2 << std::endl << std::flush;
    #define PRINT_3_VARIABLES(var1,var2,var3) std::cout << "DEBUG: " #var1 " = " << var1 << ", " \
        #var2 " = " << var2 << ", " #var3 " = " << var3 << std::endl << std::flush;
    #define PRINT_4_VARIABLES(var1,var2,var3,var4) std::cout << "DEBUG: " #var1 " = " << var1 << ", " \
        #var2 " = " << var2 << ", " #var3 " = " << var3 << ", " \
        #var4 " = " << var4 << std::endl << std::flush;
    #define PRINT_5_VARIABLES(var1,var2,var3,var4,var5) std::cout << "DEBUG: " #var1 " = " << var1 << ", " \
        #var2 " = " << var2 << ", " #var3 " = " << var3 << ", " \
    ...
    #define HOW_MANY_TIMES_HERE(message) { \
        ...
        std::cout << "DEBUG: Num times here ("<< message << "): " << counter++ << std::endl << std::flush; }
