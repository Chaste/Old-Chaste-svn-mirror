...
#ifndef NASHHUNTERPOLEZEROLAW2_HPP_
#define NASHHUNTERPOLEZEROLAW2_HPP_
...
class NashHunterPoleZeroLaw2 : public PoleZeroMaterialLaw2<DIM>
{
friend class TestMaterialLaws2;

public :
    NashHunterPoleZeroLaw2()
        : PoleZeroMaterialLaw2<DIM>()
    {
        assert(DIM==2 || DIM==3);
        if (DIM==2)
        {
...
#endif /*NASHHUNTERPOLEZEROLAW2_HPP_*/
