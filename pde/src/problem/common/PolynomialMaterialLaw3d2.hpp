...
#ifndef POLYNOMIALMATERIALLAW3D2_HPP_
#define POLYNOMIALMATERIALLAW3D2_HPP_
 ...
 */
class PolynomialMaterialLaw3d2 : public AbstractIsotropicIncompressibleMaterialLaw2<3>
{
private :
    unsigned mN;
...
public :
    PolynomialMaterialLaw3d2(unsigned N, std::vector<std::vector<double> > alpha)
    {
        if (N==0)
        {
