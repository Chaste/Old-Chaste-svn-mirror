...
public class Visualize2dSpheroid implements ActionListener, AdjustmentListener, ItemListener, Runnable
{
    ...
    public static void main(String args[]) 
    {
        ...
        Visualize2dSpheroid vis = new Visualize2dSpheroid();
        ...
        try 
        {
            ...
            if (setupFilePresent)
            {
                ...
                while (line_setup != null)
                {
                    ...
                    if (parameter.equals("FinalMeshSize"))  // .equals?? That took some doing!
                    {
                        crypt_width = Double.valueOf(st_setup.nextToken());
                        half_width = crypt_width/2.0;
                        System.out.println("Final mesh size = " + crypt_width);
...
class CustomCanvas2D extends Canvas implements MouseMotionListener {
    ...
    public CustomCanvas2D(Visualize2dSpheroid v) {
        vis = v;
