#ifndef _TESTVECTORUBLAS_HPP_
#define _TESTVECTORUBLAS_HPP_

#include "VectorUblas.hpp"

class TestVectorUblas : public CxxTest::TestSuite
{
	public:
    ...
    void TestConstructor()
	{
        ...
        VectorUblas B(2);
        TS_ASSERT_DELTA(B(0), 0.0, 0.0000000001);
        TS_ASSERT_DELTA(B(1), 0.0, 0.0000000001);
        VectorUblas C(3);
        TS_ASSERT_DELTA(C(0), 0.0, 0.0000000001);
        TS_ASSERT_DELTA(C(1), 0.0, 0.0000000001);
        TS_ASSERT_DELTA(C(2), 0.0, 0.0000000001);
        VectorUblas D(4);
        TS_ASSERT_DELTA(D(0), 0.0, 0.0000000001);
        TS_ASSERT_DELTA(D(1), 0.0, 0.0000000001);
        TS_ASSERT_DELTA(D(2), 0.0, 0.0000000001);
        TS_ASSERT_DELTA(D(3), 0.0, 0.0000000001);

        TS_ASSERT_THROWS_ANYTHING(VectorUblas E(5));
 	}
