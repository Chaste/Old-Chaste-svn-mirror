...
class TestVectorDouble : public CxxTest::TestSuite
{
     ...
     */
     ...
     void TestConvertVectorDoubleToUblas()
     {
        VectorDouble z(1);
        z(0)=3;
        c_vector<double, 1>& z_ublas_vector = z.rGetUblasHandle1();
        TS_ASSERT_EQUALS(z(0), z_ublas_vector(0));
        
        VectorDouble a(2);
        a(0)=3; a(1)=4;
        c_vector<double, 2>& a_ublas_vector = a.rGetUblasHandle2();
        TS_ASSERT_EQUALS(a(0), a_ublas_vector(0));
        TS_ASSERT_EQUALS(a(1), a_ublas_vector(1));
        
        VectorDouble b(3);
        b(0)=3; b(1)=4; b(2)=10;
        c_vector<double, 3>& b_ublas_vector = b.rGetUblasHandle3();
        ...
        c_vector<double, 4>& c_ublas_vector = c.rGetUblasHandle4();
