...
class TestVectorDoubleUblasConverter : public CxxTest::TestSuite
{
	...
	void TestConvertor()
    {
        ...
        c_vector<double, 2>* a_ublas_vector = converter2.ConvertToUblas(a);
        ...
        c_vector<double, 3>* b_ublas_vector = converter3.ConvertToUblas(b);
    ...
    void TestSetWithConvertor()
    {
        ...
        c_vector<double, 1>* a_ublas_vector = converter1.ConvertToUblas(a);
