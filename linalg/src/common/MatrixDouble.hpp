...
//        
          ...
          c_matrix<double, 1,1>& rGetUblasHandle1( void ) const;
          c_matrix<double, 2,2>& rGetUblasHandle2( void ) const;
          c_matrix<double, 3,3>& rGetUblasHandle3( void ) const;
          c_matrix<double, 4,4>& rGetUblasHandle4( void ) const;
