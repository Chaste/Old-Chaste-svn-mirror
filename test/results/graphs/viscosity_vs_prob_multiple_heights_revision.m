%function [ output_args ] = viscosity_vs_prob_multiple_heights_revision( input_args )
...
% We have special extra runs for the vanilla case
[this_bucket_height success_prob vanilla_errors] = probability_of_domination_adhesion_only();
...
for m=1:length(settings.mutations)
    ...
    hold on
    plot(this_bucket_height,success_prob,'k:')
