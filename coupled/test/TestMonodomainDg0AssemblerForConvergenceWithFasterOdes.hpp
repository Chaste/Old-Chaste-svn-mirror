#ifndef _TESTMONODOMAINDG0ASSEMBLERFORCONVERGENCEWITHFASTERODES_HPP_
#define _TESTMONODOMAINDG0ASSEMBLERFORCONVERGENCEWITHFASTERODES_HPP_
...
//       the cell model will blow up).
    ...
    AbstractCardiacCell* CreateCardiacCellForNode(unsigned node)
    {
        ...
        {
            return new BackwardEulerLuoRudyIModel1991(mTimeStep, mpStimulus);
        }
        else
        {
            return new BackwardEulerLuoRudyIModel1991(mTimeStep, mpZeroStimulus);
        }
    }
...
class TestMonodomainDg0AssemblerForConvergenceWithFasterOdes : public CxxTest::TestSuite
{
private:
...
//       for (int middle_node=1; middle_node<100; middle_node*=2){
        ...
        TS_ASSERT_EQUALS(time_step, 0.005);
...
#endif //_TESTMONODOMAINDG0ASSEMBLERFORCONVERGENCEWITHFASTERODES_HPP_
