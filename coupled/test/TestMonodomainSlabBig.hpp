#ifndef TESTMONODOMAINSLABBIG_HPP_
#define TESTMONODOMAINSLABBIG_HPP_
...
public:
    ...
    void TestMonodomainSlabBigWithCornerNodesStimulated( void )
    {
        ...
        MonodomainProblem<3> monodomainProblem("mesh/test/data/3D_0_to_100mm_6000_elements",
                                               10,   // ms
...
#endif /*TESTMONODOMAINSLABBIG_HPP_*/
