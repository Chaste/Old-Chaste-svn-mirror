...
public:
    ...
    void TestMonodomainProblemCreates3DGeometry()
    {
        ...
        // The files written in parallel differ slightly from the ones written in sequential 
        // (by the last decimal figure in some points in the file), here we test against the sequential ones.
        EXIT_IF_PARALLEL 
