...
//#else
        ...
        // This test used to throw an error because the gating variables went out of range,
        // but there is no test for this with autogenerated cell models at the moment.
        monodomain_problem.Solve();
//#endif
    }
