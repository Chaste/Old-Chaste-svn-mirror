...
public:
// to be deleted after commiting
//
//    void TestCompareAllSolvers() throw(Exception)
//    {   
...
//    
//            nhs_forward.SetStretchAndStretchRate(1.0,0.0);
//                    
...
//                input_parameters.intracellularCalciumConcentration = electrophys_model.rGetStateVariables()[3];
//                nhs_forward.SetInputParameters(input_parameters);
//    
//                //nhs_forward.RunAndUpdate(time, time+dt, dt);
//                
//                times.push_back(time);
//                active_tensions.push_back(nhs_forward.GetActiveTension());
//            }
//    
//            Timer::Print("LR only");
//        }
...
//        {
//            Timer::Reset();
//            NhsModelWithImplicitSolver nhs_backward;
//            nhs_backward.UseImplicitExplicitSolveForZ();
//    
//            nhs_backward.SetStretchAndStretchRate(1.0,0.0);
//                    
//            boost::shared_ptr<SimpleStimulus> p_stimulus(new SimpleStimulus(-25.5, 2.0, 0.0));
//    
//            boost::shared_ptr<EulerIvpOdeSolver> p_solver(new EulerIvpOdeSolver);
//            LuoRudyIModel1991OdeSystem electrophys_model2(p_solver, p_stimulus);
//    
//            std::vector<double> times;
//            std::vector<double> active_tensions;
//    
...
//            {
//                // solve electrophys model
//                electrophys_model2.Compute(time, time+dt);
//    
//                ContractionModelInputParameters input_parameters;
//                input_parameters.intracellularCalciumConcentration = electrophys_model2.rGetStateVariables()[3];
//                nhs_backward.SetInputParameters(input_parameters);
//    
//                nhs_backward.RunDoNotUpdate(time, time+dt, dt);
//                nhs_backward.UpdateStateVariables();
//                
//                times.push_back(time);
//                active_tensions.push_back(nhs_backward.GetActiveTension());
//            }    
//            Timer::Print("Backward");
//            
//            std::vector<std::vector<double> > data;
//            data.push_back(times);
//            data.push_back(active_tensions);
//            SimpleDataWriter writer("TestNhsStuff", "backward.dat", data, false);
//        }
//
//
//
//        {
//            Timer::Reset();
//            NhsModelWithBackwardSolver nhs_basic_backward;
//    
//            nhs_basic_backward.SetStretchAndStretchRate(1.0,0.0);
//                    
//            boost::shared_ptr<SimpleStimulus> p_stimulus(new SimpleStimulus(-25.5, 2.0, 0.0));
//    
//            boost::shared_ptr<EulerIvpOdeSolver> p_solver(new EulerIvpOdeSolver);
...
//                ContractionModelInputParameters input_parameters;
//                input_parameters.intracellularCalciumConcentration = electrophys_model2.rGetStateVariables()[3];
//                nhs_basic_backward.SetInputParameters(input_parameters);
//    
//                nhs_basic_backward.RunDoNotUpdate(time, time+dt, dt);
//                nhs_basic_backward.UpdateStateVariables();
//                
//                times.push_back(time);
//                active_tensions.push_back(nhs_basic_backward.GetActiveTension());
//            }
//    
//            Timer::Print("Basic backward");
//            
//            std::vector<std::vector<double> > data;
//            data.push_back(times);
//            data.push_back(active_tensions);
//            SimpleDataWriter writer("TestNhsStuff", "basicbackward.dat", data, false);
//        }
//
//    }
//
