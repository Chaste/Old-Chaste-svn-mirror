...
public:
    void TestCardiacSimulationConstructor() throw(Exception)
    {
        ...
        std::string command = "h5dump " + testoutput_dir + "BaseBidomain/SimulationResults.h5 > " +  testoutput_dir + "BaseBidomain/dumped.txt";
        ...
        command = "diff --ignore-matching-lines=HDF5 heart/test/data/cardiac_simulations/base_bidomain_results.h5 " +  testoutput_dir + "BaseBidomain/dumped.txt ";
