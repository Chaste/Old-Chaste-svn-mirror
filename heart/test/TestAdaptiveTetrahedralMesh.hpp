...
public:
    ...
    void TestConstructAdaptiveTetrahedralMeshFromVtu(void) throw(Exception)
    {
        ...
        adaptive_mesh->ConstructFromVtuFile("notforrelease/test/data/twin_flow.vtu");
    ...
    {
#ifdef CHASTE_ADAPTIVITY
        VtkMeshReader<3,3> reader("notforrelease/test/data/coarse_slab_neumann_no_adapt0002.vtu");
...
#ifdef CHASTE_ADAPTIVITY
        AdaptiveTetrahedralMesh adaptive_mesh;
        adaptive_mesh.ConstructFromVtuFile("notforrelease/test/data/coarse_slab_neumann0002.vtu");
...
//        TS_ASSERT( !(adaptive_mesh.GetAdaptSuccess()) );
    ...
    void TestAdaptingTheCoarseSlabMesh(void) throw(Exception)
    {
        ...
        AdaptiveTetrahedralMesh adaptive_mesh;
        adaptive_mesh.ConstructFromVtuFile("notforrelease/test/data/small_bidomain_slab.vtu");
