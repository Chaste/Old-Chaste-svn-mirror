...
public:
     ...
     */
    PeregoLuoRudyIModel1991OdeSystem(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, // unused.
                                     boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus, bool useAdaptTimestep=true);
