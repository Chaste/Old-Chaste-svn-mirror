...
#include "OdeSystemInformation.hpp"
    ...
    double CellShannon2004FromCellMLCvode::Get_inward_rectifier_potassium_current_conductance_constant()
    {
    ...
    double CellShannon2004FromCellMLCvode::Get_sodium_channel_current_conductance_constant()
    {
        // Constant value given in CellML
        return 16;
    }
    ...
    double CellShannon2004FromCellMLCvode::Get_L_type_Ca_current_conductance_constant()
    {
        // Constant value given in CellML
        return 1.0;
    }
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        mpSystemInfo = OdeSystemInformation<CellShannon2004FromCellMLCvode>::Instance();
        Init();
    ...
    void CellShannon2004FromCellMLCvode::VerifyStateVariables()
    {}

    double CellShannon2004FromCellMLCvode::GetIIonic()
    {
        ...
        const double var_INa__G_INa = 16.0;
        ...
        const double var_INab__G_NaBk = 0.297e-3;
        ...
        const double var_IKr__G_IKr_const = 0.03;
        ...
        const double var_ICaL__PNa = 1.5e-8;
        ...
        const double var_ICaL__PK = 2.7e-7;
        ...
        const double var_ICaL__PCa = 5.4e-4;
        ...
        const double var_ICaL__G_CaL_mult = 1.0;
    ...
    void CellShannon2004FromCellMLCvode::EvaluateRhs(double var_environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_cell__V = this->membrane_voltage_modifier->calc(NV_Ith_S(rY, 0), var_environment__time);
        // Units: millivolt; Initial value: -85.719687955637
        double var_INa_h_gate__h = NV_Ith_S(rY, 1);
        // Units: dimensionless; Initial value: 0.987140350343
        double var_INa_j_gate__j = NV_Ith_S(rY, 2);
        ...
        const double var_reversal_potentials__E_Na_jct = ((var_reversal_potentials__R * var_reversal_potentials__T) / var_reversal_potentials__F) * log(var_reversal_potentials__Nao / var_reversal_potentials__Na_jct);
        const double var_INa__E_Na_jct = var_reversal_potentials__E_Na_jct;
        const double var_INa__G_INa = this->sodium_channel_current_conductance_modifier->calc(16.0, var_environment__time);
        const double var_INa__m = var_INa_m_gate__m;
        const double var_INa__j = var_INa_j_gate__j;
        const double var_INa__h = var_INa_h_gate__h;
        const double var_INa__openProb = pow(var_INa__m, 3.0) * var_INa__h * var_INa__j;
        ...
        const double var_ICap__Ca_jct = var_Ca_buffer__Ca_jct;
        const double var_ICap__i_Cap_jct = (var_ICap__Q_SLCaP * var_ICap__V_maxAF * var_ICap__Fx_SLCaP_jct) / (1.0 + pow(var_ICap__Km / var_ICap__Ca_jct, var_ICap__H));
        const double var_cell__i_Stim = GetStimulus(var_environment__time);
        ...
        const double var_model_parameters__Cm_per_area = 2e-6;
        ...
        const double var_Jleak_SR__KSRleak = 5.348e-6;
        ...
        const double var_Jpump_SR__V_max = 286e-6;
        ...
        const double var_Na_buffer__koff = 1e-3;
        ...
        const double var_Ca_buffer__koff_SLHigh = 30e-3;
        ...
        const double var_cytosolic_Ca_buffer__koff_Myosin_Mg = 0.057e-3;
        const double var_cytosolic_Ca_buffer__Mgi = var_Ca_buffer__Mgi;
        const double var_cytosolic_Ca_buffer__kon_Myosin_Mg = 15.7e-3;
        ...
        const double var_cytosolic_Ca_buffer__kon_TroponinC_Ca_Mg_Mg = 3e-3;
        const double var_cytosolic_Ca_buffer__koff_TroponinC_Ca_Mg_Mg = 3.33e-3;
        ...
        const double var_cytosolic_Ca_buffer__koff_TroponinC_Ca_Mg_Ca = 0.032e-3;
        ...
        const double var_cytosolic_Ca_buffer__koff_Myosin_Ca = 0.46e-3;
        ...
        const double var_cytosolic_Ca_buffer__koff_Calmodulin = 238e-3;
        ...
        const double var_cytosolic_Ca_buffer__koff_TroponinC = 19.6e-3;
        ...
        const double var_cytosolic_Ca_buffer__koff_SRB = 60e-3;
        ...
        const double var_indo_fluo_Ca_buffer_not_connected__Bmax_Indo1_jct = 0.00002;
        ...
        const double var_indo_fluo_Ca_buffer_not_connected__Bmax_Fluo3_jct = 0.00002;
        ...
        const double var_indo_fluo_Ca_buffer_not_connected__koff_Indo1 = 60e-3;
        const double var_indo_fluo_Ca_buffer_not_connected__koff_Fluo3 = 110e-3;
        ...
        else
        {
            ...
            const double var_IKr_Rr_gate__Rr = 1.0 / (1.0 + exp((33.0 + var_IKr_Rr_gate__V) / 22.4));
            const double var_IKr__Rr = var_IKr_Rr_gate__Rr;
            const double var_IKr__G_IKr_const = this->inward_rectifier_potassium_current_conductance_modifier->calc(0.03, var_environment__time);
            const double var_IKr__Ko = var_model_parameters__Ko;
            const double var_IKr__G_IKr = var_IKr__G_IKr_const * sqrt(var_IKr__Ko / 5.4);
            const double var_model_parameters__Ki = 135.0;
            const double var_reversal_potentials__Ki = var_model_parameters__Ki;
            ...
            const double var_ICaL__gamma_Ki = 0.75;
            const double var_ICaL__i_CaL_K = (var_ICaL__temp * ((var_ICaL__fCa_SL * var_ICaL__Fx_ICaL_SL) + (var_ICaL__fCa_jct * var_ICaL__Fx_ICaL_jct)) * var_ICaL__PK * ((var_ICaL__gamma_Ki * var_ICaL__Ki * exp((var_ICaL__V * var_ICaL__F) / (var_ICaL__R * var_ICaL__T))) - (var_ICaL__gamma_Ko * var_ICaL__Ko))) / (exp((var_ICaL__V * var_ICaL__F) / (var_ICaL__R * var_ICaL__T)) - 1.0);
            const double var_ICaL__G_CaL_mult = this->L_type_Ca_current_conductance_modifier->calc(1.0, var_environment__time);
            const double var_ICaL__i_CaL = var_ICaL__G_CaL_mult * (var_ICaL__i_CaL_Ca_SL + var_ICaL__i_CaL_Ca_jct + var_ICaL__i_CaL_Na_SL + var_ICaL__i_CaL_Na_jct + var_ICaL__i_CaL_K);
            const double var_cell__i_CaL = var_ICaL__i_CaL;
            const double var_ICab__i_Cab = var_ICab__i_Cab_SL + var_ICab__i_Cab_jct;
            const double var_cell__i_Cab = var_ICab__i_Cab;
        ...
        NV_Ith_S(rDY, 0) = d_dt_cell__V;
        NV_Ith_S(rDY, 1) = d_dt_INa_h_gate__h;
        NV_Ith_S(rDY, 2) = d_dt_INa_j_gate__j;
        NV_Ith_S(rDY, 3) = d_dt_INa_m_gate__m;
        NV_Ith_S(rDY, 4) = d_dt_IKr_Xr_gate__Xr;
        NV_Ith_S(rDY, 5) = d_dt_IKs_Xs_gate__Xs;
        NV_Ith_S(rDY, 6) = d_dt_Itos_X_gate__X_tos;
        NV_Ith_S(rDY, 7) = d_dt_Itos_Y_gate__Y_tos;
        NV_Ith_S(rDY, 8) = d_dt_Itos_R_gate__R_tos;
        NV_Ith_S(rDY, 9) = d_dt_Itof_X_gate__X_tof;
        NV_Ith_S(rDY, 10) = d_dt_Itof_Y_gate__Y_tof;
        NV_Ith_S(rDY, 11) = d_dt_ICaL_d_gate__d;
        NV_Ith_S(rDY, 12) = d_dt_ICaL_f_gate__f;
        NV_Ith_S(rDY, 13) = d_dt_ICaL_fCa_gate__fCaB_SL;
        NV_Ith_S(rDY, 14) = d_dt_ICaL_fCa_gate__fCaB_jct;
        NV_Ith_S(rDY, 15) = d_dt_Jrel_SR__R;
        NV_Ith_S(rDY, 16) = d_dt_Jrel_SR__I;
        NV_Ith_S(rDY, 17) = d_dt_Jrel_SR__O;
        NV_Ith_S(rDY, 18) = d_dt_Na_buffer__Na_SL;
        NV_Ith_S(rDY, 19) = d_dt_Na_buffer__Na_jct;
        NV_Ith_S(rDY, 20) = d_dt_Na_buffer__Na_SL_buf;
        NV_Ith_S(rDY, 21) = d_dt_Na_buffer__Na_jct_buf;
        NV_Ith_S(rDY, 22) = d_dt_Na_buffer__Nai;
        NV_Ith_S(rDY, 23) = d_dt_Ca_buffer__Ca_SR;
        NV_Ith_S(rDY, 24) = d_dt_Ca_buffer__Ca_SL;
        NV_Ith_S(rDY, 25) = d_dt_Ca_buffer__Ca_jct;
        NV_Ith_S(rDY, 26) = d_dt_Ca_buffer__Cai;
        NV_Ith_S(rDY, 27) = d_dt_Ca_buffer__Ca_SLB_SL;
        NV_Ith_S(rDY, 28) = d_dt_Ca_buffer__Ca_SLB_jct;
        NV_Ith_S(rDY, 29) = d_dt_Ca_buffer__Ca_SLHigh_SL;
        NV_Ith_S(rDY, 30) = d_dt_Ca_buffer__Ca_SLHigh_jct;
        NV_Ith_S(rDY, 31) = d_dt_Ca_buffer__Ca_Calsequestrin;
        NV_Ith_S(rDY, 32) = d_dt_cytosolic_Ca_buffer__Ca_TroponinC;
        NV_Ith_S(rDY, 33) = d_dt_cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg;
        NV_Ith_S(rDY, 34) = d_dt_cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        NV_Ith_S(rDY, 35) = d_dt_cytosolic_Ca_buffer__Ca_Calmodulin;
        NV_Ith_S(rDY, 36) = d_dt_cytosolic_Ca_buffer__Ca_Myosin;
        NV_Ith_S(rDY, 37) = d_dt_cytosolic_Ca_buffer__Mg_Myosin;
        NV_Ith_S(rDY, 38) = d_dt_cytosolic_Ca_buffer__Ca_SRB;
        NV_Ith_S(rDY, 39) = d_dt_indo_fluo_Ca_buffer_not_connected__Ca_Indo1_Cytosol;
        NV_Ith_S(rDY, 40) = d_dt_indo_fluo_Ca_buffer_not_connected__Ca_Indo1_SL;
        NV_Ith_S(rDY, 41) = d_dt_indo_fluo_Ca_buffer_not_connected__Ca_Indo1_jct;
        NV_Ith_S(rDY, 42) = d_dt_indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_Cytosol;
        NV_Ith_S(rDY, 43) = d_dt_indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_SL;
        NV_Ith_S(rDY, 44) = d_dt_indo_fluo_Ca_buffer_not_connected__Ca_Fluo3_jct;
    }
