...
#undef COVERAGE_IGNORE
        ...
        _lt_0_row = BackwardEulerTenTusscher2006_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
        ...
        const double var_sodium_potassium_pump_current__i_NaK = ((2.298375 * var_sodium_dynamics__Na_i) / (var_sodium_dynamics__Na_i + 40.0)) / _lt_0_row[24];
        ...
        const double var_sodium_calcium_exchanger_current__i_NaCa = (1000.0 * ((_lt_0_row[25] * pow(var_sodium_dynamics__Na_i, 3.0) * 2.0) - (_lt_0_row[26] * 2744000.0 * var_calcium_dynamics__Ca_i * 2.5))) / _lt_0_row[27];
        ...
        const double var_potassium_pump_current__i_p_K = (0.0146 * (var_membrane__V - var_reversal_potentials__E_K)) / _lt_0_row[28];
    ...
    void BackwardEulerTenTusscher2006::ComputeResidual(double var_environment__time, const double rCurrentGuess[7], double rResidual[7])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_membrane__V = rY[0];
        // Units: millivolt; Initial value: -85.23
    ...
    void BackwardEulerTenTusscher2006::ComputeJacobian(double var_environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_membrane__V = rY[0];
        // Units: millivolt; Initial value: -85.23
...
#undef COVERAGE_IGNORE
        ...
        const double _g_0 = _lt_0_row[14] / _lt_0_row[15];
        const double _h_0 = (-1.0) / _lt_0_row[15];
        const double _g_1 = _lt_0_row[18] / _lt_0_row[19];
        const double _h_1 = (-1.0) / _lt_0_row[19];
        const double _g_2 = _lt_0_row[16] / _lt_0_row[17];
        const double _h_2 = (-1.0) / _lt_0_row[17];
        const double _g_3 = _lt_0_row[8] / _lt_0_row[9];
        const double _h_3 = (-1.0) / _lt_0_row[9];
        const double _g_4 = _lt_0_row[10] / _lt_0_row[11];
        const double _h_4 = (-1.0) / _lt_0_row[11];
        const double _g_5 = _lt_0_row[6] / _lt_0_row[7];
        const double _h_5 = (-1.0) / _lt_0_row[7];
        const double _g_6 = _lt_0_row[0] / _lt_0_row[1];
        const double _h_6 = (-1.0) / _lt_0_row[1];
        const double _g_7 = _lt_0_row[2] / _lt_0_row[3];
        const double _h_7 = (-1.0) / _lt_0_row[3];
        const double _g_8 = _lt_0_row[4] / _lt_0_row[5];
        const double _h_8 = (-1.0) / _lt_0_row[5];
        const double _g_9 = _lt_0_row[22] / _lt_0_row[23];
        const double _h_9 = (-1.0) / _lt_0_row[23];
        const double _g_10 = _lt_0_row[20] / _lt_0_row[21];
        const double _h_10 = (-1.0) / _lt_0_row[21];
