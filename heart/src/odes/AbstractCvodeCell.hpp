...
public:
    ...
    /**
     * Get the intracellular stimulus.
     * @return pStimulus
     */
    ...
    /**
     * This method throws an Exception. It is overridden in the
     * autogenerated subclasses for cells with enough CellML metadata
     * to make a RegularStimulus the same as specified in CellML.
     */
