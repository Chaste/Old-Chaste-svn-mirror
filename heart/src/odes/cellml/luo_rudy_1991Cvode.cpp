...
#include "OdeSystemInformation.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1991FromCellMLCvode>::Instance();
        Init();
    ...
    void Cellluo_rudy_1991FromCellMLCvode::VerifyStateVariables()
    {}

    double Cellluo_rudy_1991FromCellMLCvode::GetIIonic()
    {
    ...
    void Cellluo_rudy_1991FromCellMLCvode::EvaluateRhs(double var_environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_membrane__V = NV_Ith_S(rY, 0);
        ...
        const double var_membrane__I_stim = GetStimulus(var_environment__time);
        const double var_fast_sodium_current__V = var_membrane__V;
        const double var_slow_inward_current__d = var_slow_inward_current_d_gate__d;
        const double var_slow_inward_current__f = var_slow_inward_current_f_gate__f;
        const double var_slow_inward_current__V = var_membrane__V;
        ...
        NV_Ith_S(rDY, 0) = d_dt_membrane__V;
        NV_Ith_S(rDY, 1) = d_dt_fast_sodium_current_m_gate__m;
        NV_Ith_S(rDY, 2) = d_dt_fast_sodium_current_h_gate__h;
        NV_Ith_S(rDY, 3) = d_dt_fast_sodium_current_j_gate__j;
        NV_Ith_S(rDY, 4) = d_dt_slow_inward_current_d_gate__d;
        NV_Ith_S(rDY, 5) = d_dt_slow_inward_current_f_gate__f;
        NV_Ith_S(rDY, 6) = d_dt_time_dependent_potassium_current_X_gate__X;
        NV_Ith_S(rDY, 7) = d_dt_intracellular_calcium_concentration__Cai;
    }
...
void OdeSystemInformation<Cellluo_rudy_1991FromCellMLCvode>::Initialise(void)
{
    ...
    this->mParameterNames.push_back("g_Na");
