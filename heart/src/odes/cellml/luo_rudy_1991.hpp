#ifndef _Cellluo_rudy_1991FromCellML_
#define _Cellluo_rudy_1991FromCellML_
...
public:
    Cellluo_rudy_1991FromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, 
...
BOOST_CLASS_EXPORT(Cellluo_rudy_1991FromCellML)
namespace boost
{
