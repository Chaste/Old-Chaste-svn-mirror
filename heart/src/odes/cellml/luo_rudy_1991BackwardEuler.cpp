...
//!     (translate: 8576, pycml: 8196)
//! on Wed Apr  7 16:12:39 2010
//! 
//! <autogenerated>
...
#undef COVERAGE_IGNORE
    ...
    void CML_luo_rudy_1991_pe_lut_be::ComputeResidual(double var_environment__time, const double rCurrentGuess[1], double rResidual[1])
    {
        ...
        rResidual[0] = rCurrentGuess[0] - rY[7] - mDt*1.0*d_dt_intracellular_calcium_concentration__Cai;
    }
...
#undef COVERAGE_IGNORE
        ...
        rY[1] = (rY[1] + _g_2*dt) / (1 - _h_2*dt);
        rY[2] = (rY[2] + _g_0*dt) / (1 - _h_0*dt);
        rY[3] = (rY[3] + _g_1*dt) / (1 - _h_1*dt);
        rY[4] = (rY[4] + _g_3*dt) / (1 - _h_3*dt);
        rY[5] = (rY[5] + _g_4*dt) / (1 - _h_4*dt);
        rY[6] = (rY[6] + _g_5*dt) / (1 - _h_5*dt);
