...
{    
   ...
   transient_outward_current_i_to = transient_outward_current_g_to*Y[17]*Y[18]*(Y[11]-reversal_potentials_E_K);
   rapid_time_dependent_potassium_current_i_Kr = rapid_time_dependent_potassium_current_g_Kr*sqrt(potassium_dynamics_K_o/5.4)*Y[13]*Y[14]*(Y[11]-reversal_potentials_E_K);
   ...
   slow_time_dependent_potassium_current_i_Ks = slow_time_dependent_potassium_current_g_Ks*pow(Y[15], 2.0)*(Y[11]-reversal_potentials_E_Ks);
