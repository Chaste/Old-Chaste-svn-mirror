...
#ifndef HEART_PHYSIOLOGICAL_PARAMETERS_HPP
#define HEART_PHYSIOLOGICAL_PARAMETERS_HPP
...
//
class ConductivitiesType;
class HeartPhysiologicalParametersType;
...
class ConductivitiesType: public ::xml_schema::type
{
  public:

  struct _xsd_ConductivitiesType
  {
  ...
  void
  Conductivity (const Conductivity::container&);
  ...
  ConductivitiesType (const ::xercesc::DOMElement&,
                      ::xml_schema::flags = 0,
                      ::xml_schema::type* = 0);

  ConductivitiesType (const ConductivitiesType&,
                      ::xml_schema::flags = 0,
                      ::xml_schema::type* = 0);

  virtual ConductivitiesType*
  ...
  ::xsd::cxx::tree::sequence< Conductivity::type > _xsd_Conductivity_;
};

class HeartPhysiologicalParametersType: public ::xml_schema::type
{
  public:

  struct _xsd_HeartPhysiologicalParametersType
  {
    typedef ::xml_schema::type base_;
  };
  ...
  // 
  public:
  struct Conductivities
  {
    typedef ::ConductivitiesType type;
    typedef ::xsd::cxx::tree::traits< type, char > traits;
  };

  const Conductivities::type&
  ...
  void
  Conductivities (const Conductivities::type&);

  void
  Conductivities (::std::auto_ptr< Conductivities::type >);

  // Constructors.
  //
  public:
  HeartPhysiologicalParametersType (const SurfaceAreaToVolumeRatio::type&,
                                    const Capacitance::type&,
                                    const Conductivities::type&);

  HeartPhysiologicalParametersType (const ::xercesc::DOMElement&,
                                    ::xml_schema::flags = 0,
                                    ::xml_schema::type* = 0);

  HeartPhysiologicalParametersType (const HeartPhysiologicalParametersType&,
                                    ::xml_schema::flags = 0,
                                    ::xml_schema::type* = 0);

  virtual HeartPhysiologicalParametersType*
  _clone (::xml_schema::flags = 0,
          ::xml_schema::type* = 0) const;
  ...
  ::xsd::cxx::tree::one< Conductivities::type > _xsd_Conductivities_;
};
...
HeartPhysiologicalParameters (const ::std::basic_string< char >&,
                              ::xml_schema::flags = 0,
...
::std::auto_ptr< ::HeartPhysiologicalParametersType >
HeartPhysiologicalParameters (::std::istream&,
                              ::xml_schema::flags = 0,
                              const ::xsd::cxx::tree::properties< char >& = ::xsd::cxx::tree::properties< char > ());
...
::std::auto_ptr< ::HeartPhysiologicalParametersType >
HeartPhysiologicalParameters (const ::xercesc::DOMInputSource&,
                              ::xml_schema::flags = 0,
                              const ::xsd::cxx::tree::properties< char >& = ::xsd::cxx::tree::properties< char > ());
...
::std::auto_ptr< ::HeartPhysiologicalParametersType >
HeartPhysiologicalParameters (const ::xercesc::DOMDocument&,
                              ::xml_schema::flags = 0,
                              const ::xsd::cxx::tree::properties< char >& = ::xsd::cxx::tree::properties< char > ());
...
#endif // HEART_PHYSIOLOGICAL_PARAMETERS_HPP
