...
class Cellluo_rudy_1991FromCellMLOpt_LookupTables
{
public:
    static Cellluo_rudy_1991FromCellMLOpt_LookupTables* Instance()
    {
        if (mpInstance == NULL)
        {
            mpInstance = new Cellluo_rudy_1991FromCellMLOpt_LookupTables;
        }
        return mpInstance;
    }
...
private:
    ...
    static Cellluo_rudy_1991FromCellMLOpt_LookupTables *mpInstance;
...
Cellluo_rudy_1991FromCellMLOpt_LookupTables* Cellluo_rudy_1991FromCellMLOpt_LookupTables::mpInstance = NULL;

    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__I_stim()
    {
        return var_membrane__I_stim;
    }
    
    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__i_Na()
    {
        return var_membrane__i_Na;
    }
    
    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__i_si()
    {
        return var_membrane__i_si;
    }
    
    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__i_K()
    {
        return var_membrane__i_K;
    }
    
    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__i_K1()
    {
        return var_membrane__i_K1;
    }
    
    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__i_Kp()
    {
        return var_membrane__i_Kp;
    }
    
    double Cellluo_rudy_1991FromCellMLOpt::Get_membrane__i_b()
    {
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        mpSystemInfo = OdeSystemInformation<Cellluo_rudy_1991FromCellMLOpt>::Instance();
        Init();
    ...
    double Cellluo_rudy_1991FromCellMLOpt::GetIIonic()
    {
...
#undef COVERAGE_IGNORE
        ...
        double* _lt_0_row = Cellluo_rudy_1991FromCellMLOpt_LookupTables::Instance()->_lookup_0_row(_table_index_0, _factor_0);
    ...
    void Cellluo_rudy_1991FromCellMLOpt::EvaluateYDerivatives(double var_environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_membrane__V = rY[0];
...
extern "C"
{
    AbstractCardiacCell* MakeCardiacCell(
            boost::shared_ptr<AbstractIvpOdeSolver> pSolver,
            boost::shared_ptr<AbstractStimulusFunction> pStimulus)
    {
        return new Cellluo_rudy_1991FromCellMLOpt(pSolver, pStimulus);
    }
