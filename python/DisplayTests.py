...
def profileHistoryGraph(req, buildType, machine, testSuite, n=20):
  ...
  from pychart import theme, axis, area, line_style, line_plot, canvas, category_coord
...
def _linkRecent(text, type, show):
  "Return a link tag to the recent tests page, with given show flag."
  query = 'recent?type=%s&amp;show=%s' % (type, show)
