...
//        mpNewTestWriter->Close();
    ...
    void testQuestion6(void)
    {
        ...
        // Instantiate PDE object for oxygen concentration
        Practical1Question2Pde<SPACE_DIM> concentrationPde;
        // Instantiate PDE object for cell Pressure
        Practical1Question3Pde<SPACE_DIM> cellPressurePde;  
...
//            }
            ...
            {
                rescalePoint = mesh.GetNodeAt(i)->GetPoint();
