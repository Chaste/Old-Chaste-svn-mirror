...
public:
    ...
    {        
        ...
        TS_ASSERT_DELTA(normal_derivs[0], 7.593844984802429, 1e-5);
        TS_ASSERT_DELTA(normal_derivs[1], 0.030500000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs[2], 0.050000000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs[3], 0.025000000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs[4], -0.090100000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs[5], 0.0, 1e-5);
        // ...and a cancer cell        
        TS_ASSERT_DELTA(cancer_derivs[0], 7.593844984802429, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs[1], 0.030600000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs[2], 0.0070000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs[3], 0.025000000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs[4], -0.090100000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs[5], 0.0, 1e-5);
        ...
        TS_ASSERT_DELTA(normal_derivs2[0], 7.593844984802429, 1e-5);
        TS_ASSERT_DELTA(normal_derivs2[1], 0.030250000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs2[2], 0.049090909090909, 1e-5);
        TS_ASSERT_DELTA(normal_derivs2[3], 0.025000000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs2[4], -0.090100000000000, 1e-5);
        TS_ASSERT_DELTA(normal_derivs2[5], 0.0, 1e-5);
        // ...and a cancer cell                
        
        TS_ASSERT_DELTA(cancer_derivs2[0], 7.593844984802429, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs2[1], 0.030350000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs2[2], 0.006090909090909, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs2[3], 0.025000000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs2[4], -0.090100000000000, 1e-5);
        TS_ASSERT_DELTA(cancer_derivs2[5], 0.0, 1e-5);
    }
    ...
    void TestAlarcon2004Solver() throw(Exception)
    {
        ...
        solutions = rk4_solver.Solve(&alarcon_system, initial_conditions, 0.0, 600.0, h_value, h_value);
        end_time = std::clock();
        ...
        start_time = std::clock();
        solutions = rkf_solver.Solve(&alarcon_system, initial_conditions, 0.0, 600.0, h_value, 1e-4);
        end_time = std::clock();
        elapsed_time = (end_time - start_time)/(CLOCKS_PER_SEC);
        ...
        TS_ASSERT_DELTA(solutions.rGetTimes()[end] , 557.181382481066 , 1e-1);
