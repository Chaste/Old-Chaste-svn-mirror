...
public:
    ...
    void Test1dCryptWithNoBirthOrDeath() throw(Exception)
    {
        ...
        TS_ASSERT_EQUALS(system(("diff " + node_results_file + " cancer/test/data/Crypt1dWithNoBirthAndNoDeath/results.viznodes").c_str()), 0);

        std::string cell_type_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizcelltypes";
        TS_ASSERT_EQUALS(system(("diff " + cell_type_results_file + " cancer/test/data/Crypt1dWithNoBirthAndNoDeath/results.vizcelltypes").c_str()), 0);

        std::string elem_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizelements";
        TS_ASSERT_EQUALS(system(("diff " + elem_results_file + " cancer/test/data/Crypt1dWithNoBirthAndNoDeath/results.vizelements").c_str()), 0);
    }
    ...
    void Test1dCryptWithDeathButNoBirth() throw(Exception)
    {
        ...
        std::string node_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.viznodes";
        TS_ASSERT_EQUALS(system(("diff " + node_results_file + " cancer/test/data/Crypt1dWithDeathButNoBirth/results.viznodes").c_str()), 0);

        std::string cell_type_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizcelltypes";
        TS_ASSERT_EQUALS(system(("diff " + cell_type_results_file + " cancer/test/data/Crypt1dWithDeathButNoBirth/results.vizcelltypes").c_str()), 0);

        std::string elem_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizelements";
        TS_ASSERT_EQUALS(system(("diff " + elem_results_file + " cancer/test/data/Crypt1dWithDeathButNoBirth/results.vizelements").c_str()), 0);
    }
    ...
    void Test1dCryptWithBirthButNoDeath() throw (Exception)
    {
        ...
        std::string node_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.viznodes";
        TS_ASSERT_EQUALS(system(("diff " + node_results_file + " cancer/test/data/Crypt1dWithCells/results.viznodes").c_str()), 0);

        std::string cell_type_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizcelltypes";
        TS_ASSERT_EQUALS(system(("diff " + cell_type_results_file + " cancer/test/data/Crypt1dWithCells/results.vizcelltypes").c_str()), 0);

        std::string elem_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizelements";
        TS_ASSERT_EQUALS(system(("diff " + elem_results_file + " cancer/test/data/Crypt1dWithCells/results.vizelements").c_str()), 0);
    }
    ...
    void Test1dCryptWithBirthAndDeath() throw (Exception)
    {
        ...
        std::string node_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.viznodes";
        TS_ASSERT_EQUALS(system(("diff " + node_results_file + " cancer/test/data/Crypt1dWithCellsAndGrowth/results.viznodes").c_str()), 0);

        std::string cell_type_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizcelltypes";
        TS_ASSERT_EQUALS(system(("diff " + cell_type_results_file + " cancer/test/data/Crypt1dWithCellsAndGrowth/results.vizcelltypes").c_str()), 0);

        std::string elem_results_file = handler.GetOutputDirectoryFullPath() + "results_from_time_0/results.vizelements";
        TS_ASSERT_EQUALS(system(("diff " + elem_results_file + " cancer/test/data/Crypt1dWithCellsAndGrowth/results.vizelements").c_str()), 0);
    }
