...
public:
    ...
    {        
        ...
        TS_ASSERT_THROWS_NOTHING(tissue.CreateOutputFiles(output_directory, false, true, true, false, false));
        
        tissue.WriteResultsToFiles(true, true, false, false);

        TS_ASSERT_THROWS_NOTHING(tissue.CloseOutputFiles(true, true, false, false));
