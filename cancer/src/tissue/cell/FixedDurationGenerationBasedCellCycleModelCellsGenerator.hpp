...
*/
#ifndef FIXEDDURATIONGENERATIONBASEDCELLCYCLEMODELCELLSGENERATOR_HPP_
#define FIXEDDURATIONGENERATIONBASEDCELLCYCLEMODELCELLSGENERATOR_HPP_
 ...
 * FixedDurationGenerationBasedCellCycleModels for a given mesh.
 */
template<unsigned DIM>
class FixedDurationGenerationBasedCellCycleModelCellsGenerator : public AbstractCellsGenerator<DIM>
{
public:

    /**
     * @return a pointer to a new FixedDurationGenerationBasedCellCycleModel.
     */
...
#endif /*FIXEDDURATIONGENERATIONBASEDCELLCYCLEMODELCELLSGENERATOR_HPP_*/
