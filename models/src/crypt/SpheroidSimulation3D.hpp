#ifndef SPHEROIDSIMULATION3D_HPP_
#define SPHEROIDSIMULATION3D_HPP_
...
/**
 * Solve a 3D spheroid simulation based on the Meineke paper.
 *
...
//    
    ...
    RandomCellKiller<3> *mpCellKiller;
    ...
    Point<3> GetNewNodeLocation(const unsigned& rOldNodeIndex, const std::vector< std::vector<double> >& rDrDt);
...
public:
    ...
    SpheroidSimulation3D(ConformingTetrahedralMesh<3,3> &rMesh,
                              std::vector<MeinekeCryptCell> cells = std::vector<MeinekeCryptCell>());
    ~SpheroidSimulation3D();
    ...
    void SetCellKiller(RandomCellKiller<3>* pCellKiller);
...
#endif /*SPHEROIDSIMULATION3D_HPP_*/
