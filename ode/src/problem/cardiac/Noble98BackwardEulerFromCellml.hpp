...
//     (translate: $Revision: 577 $, pycml: $Revision: 577 $)
// on Tue Jan 30 11:50:29 2007
...
public:
    ...
    void ComputeResidual(const double rCurrentGuess[12], double rResidual[12])
    {
        ...
        double var_intracellular_calcium_concentration__V_Cell = (3.141592654 * pow(var_intracellular_calcium_concentration__radius / 1000.0, 2.0) * var_intracellular_calcium_concentration__length) / 1000.0;
        ...
        double d_dt_L_type_Ca_channel_f2_gate__f2 = 1.0 - ((var_L_type_Ca_channel_f2_gate__Ca_i / (var_L_type_Ca_channel_f2_gate__Km_f2 + var_L_type_Ca_channel_f2_gate__Ca_i)) + var_L_type_Ca_channel_f2_gate__f2);
        ...
        rResidual[0] = rCurrentGuess[0] - rY[8] - mDt*d_dt_L_type_Ca_channel_f2_gate__f2;
        rResidual[1] = rCurrentGuess[1] - rY[9] - mDt*d_dt_L_type_Ca_channel_f2ds_gate__f2ds;
        rResidual[2] = rCurrentGuess[2] - rY[12] - mDt*d_dt_calcium_release__ActFrac;
        rResidual[3] = rCurrentGuess[3] - rY[13] - mDt*d_dt_calcium_release__ProdFrac;
        rResidual[11] = rCurrentGuess[11] - rY[14] - mDt*d_dt_intracellular_sodium_concentration__Na_i;
        rResidual[10] = rCurrentGuess[10] - rY[15] - mDt*d_dt_intracellular_potassium_concentration__K_i;
        rResidual[7] = rCurrentGuess[7] - rY[16] - mDt*d_dt_intracellular_calcium_concentration__Ca_i;
        rResidual[6] = rCurrentGuess[6] - rY[17] - mDt*d_dt_intracellular_calcium_concentration__Ca_ds;
        rResidual[9] = rCurrentGuess[9] - rY[18] - mDt*d_dt_intracellular_calcium_concentration__Ca_up;
        rResidual[8] = rCurrentGuess[8] - rY[19] - mDt*d_dt_intracellular_calcium_concentration__Ca_rel;
        rResidual[4] = rCurrentGuess[4] - rY[20] - mDt*d_dt_intracellular_calcium_concentration__Ca_Calmod;
        rResidual[5] = rCurrentGuess[5] - rY[21] - mDt*d_dt_intracellular_calcium_concentration__Ca_Trop;
    }
    ...
    void ComputeJacobian(const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = (-mDt) * (((-1.0) / (var_L_type_Ca_channel__Km_f2 + var_intracellular_calcium_concentration__Ca_i)) + (var_intracellular_calcium_concentration__Ca_i / pow(var_L_type_Ca_channel__Km_f2 + var_intracellular_calcium_concentration__Ca_i, 2.0)));
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 + (mDt * var_L_type_Ca_channel__R_decay);
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = ((-mDt) * var_L_type_Ca_channel__R_decay) * (((-1.0) / (var_L_type_Ca_channel__Km_f2ds + var_intracellular_calcium_concentration__Ca_ds)) + (var_intracellular_calcium_concentration__Ca_ds / pow(var_L_type_Ca_channel__Km_f2ds + var_intracellular_calcium_concentration__Ca_ds, 2.0)));
        rJacobian[1][7] = 0.0;
        rJacobian[1][8] = 0.0;
        rJacobian[1][9] = 0.0;
        rJacobian[1][10] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (((-var_intracellular_calcium_concentration__alpha_Calmod) * var_intracellular_calcium_concentration__Ca_i) - var_intracellular_calcium_concentration__beta_Calmod));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = ((-mDt) * var_intracellular_calcium_concentration__alpha_Calmod) * (var_intracellular_calcium_concentration__Calmod - var_intracellular_calcium_concentration__Ca_Calmod);
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
...
protected:
    ...
    void ComputeExceptVoltage(double var_environment__time)
    {
        ...
        double var_slow_delayed_rectifier_potassium_current_xs_gate__beta_xs = exp((-var_slow_delayed_rectifier_potassium_current_xs_gate__V) / 45.0);
        ...
        double var_fast_sodium_current_h_gate__alpha_h = 20.0 * exp((-0.125) * (var_fast_sodium_current_h_gate__V + 75.0));
        double var_fast_sodium_current_h_gate__beta_h = 2000.0 / (1.0 + (320.0 * exp((-0.1) * (var_fast_sodium_current_h_gate__V + 75.0))));
        ...
        rY[2] = (rY[2] + _g_5*mDt) / (1 - _h_5*mDt);
        rY[3] = (rY[3] + _g_6*mDt) / (1 - _h_6*mDt);
        rY[4] = (rY[4] + _g_3*mDt) / (1 - _h_3*mDt);
        rY[5] = (rY[5] + _g_2*mDt) / (1 - _h_2*mDt);
        rY[6] = (rY[6] + _g_0*mDt) / (1 - _h_0*mDt);
        rY[7] = (rY[7] + _g_1*mDt) / (1 - _h_1*mDt);
        rY[10] = (rY[10] + _g_8*mDt) / (1 - _h_8*mDt);
        rY[11] = (rY[11] + _g_7*mDt) / (1 - _h_7*mDt);
        
        double _guess[12] =
            {
                rY[8],rY[9],rY[12],rY[13],rY[14],rY[15],rY[16],rY[17],rY[18],rY[19],rY[20],rY[21]
            };
