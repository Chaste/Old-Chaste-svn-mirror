#ifndef _BackwardEulerFoxModel2002_
#define _BackwardEulerFoxModel2002_
...
class BackwardEulerFoxModel2002 : public AbstractBackwardEulerCardiacCell<3>
{
public:
    BackwardEulerFoxModel2002(double dt,
    ...
    ~BackwardEulerFoxModel2002(void)
    {
    }
    ...
    double GetIIonic()
    {
        ...
        const double var_L_type_Ca_current__P_Ca = 2.26e-05;
