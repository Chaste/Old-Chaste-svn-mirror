...
class TestOdeSolverForLR91 : public CxxTest::TestSuite
{
    ...
    void testOdeSolverForLR91WithInitialStimulus(void)
    {
        ...
        double endTime = 1000.0; //One second in milliseconds
        double timeStep = 0.01;  //1e-5 seconds in milliseconds           
    ...
    void testOdeSolverForLR91WithDelayedInitialStimulus(void)
    {
        ...
        double magnitude_of_stimulus = -80.0;  
        double duration_of_stimulus  = 0.5 ;  // ms                     
        double time_of_stimulus = 100.0; // ms
        /*
         * Collect initial data in a vector
         * 
         */  
         ...
         * Choose function for stimulus
         */             
        InitialStimulus stimulus(magnitude_of_stimulus, duration_of_stimulus, time_of_stimulus); 
        ...
        ColumnDataWriter *mpNewTestWriter;
        mpNewTestWriter = new ColumnDataWriter("testoutput","NewDelayedStimLR91");  
        int new_time_var_id=mpNewTestWriter->DefineFixedDimension("Time","ms", solution_new.mSolutions.size());
        int new_v_var_id = mpNewTestWriter->DefineVariable("V","mV");
        int new_m_var_id = mpNewTestWriter->DefineVariable("m","");
        int new_h_var_id = mpNewTestWriter->DefineVariable("h","");
    ...
    void testOdeSolverForLR91NoStimulus(void)
    {
        ...
        double x = 0.0056;
        double caI = 0.0002;
        double magnitude_of_stimulus = 0.0;  
        double duration_of_stimulus  = 0.5 ;  // ms                     
         ...
         */
        double startTime = 0.0;
        double endTime = 100.0; //100 milliseconds
        double timeStep = 0.01; // 1e-5 seconds in milliseconds            
    ...
    void testOdeSolverForLR91RegStimulus(void)
    {
         ...
         * Choose function for stimulus
         */             
        RegularStimulus stimulus(magnitude_of_stimulus, duration_of_stimulus, frequency, startStimulus);
