...
private:
  ...
  void
  MyTestGenericSolver(AbstractIvpOdeSolver& rSolver, double startTime,
  ...
  void
  MyTestSolverOnOdesWithEvents(AbstractIvpOdeSolver& rSolver)
  {
...
public:
  ...
  void TestGlobalError()
  {
    ...
    solutions_heun = heun_solver.Solve(&ode_system, state_variables, 0.0, 2.0,
        h_value, h_value);
    int last2 = solutions_heun.GetNumberOfTimeSteps();
  ...
  void TestOrderOnSimpleSystem()
    {
      ...
      int last1 = solutions_heun1.GetNumberOfTimeSteps();
      ...
      int last2 = solutions_heun2.GetNumberOfTimeSteps();
