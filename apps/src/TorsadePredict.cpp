...
/**
 * The Torsade prediction program that Mirams et al. 2010 will suggest.
 *
    ...
    try
    {
        ...
        if (argc != 5)
        {
            ExecutableSupport::PrintError(
                                 "TorsadePredict::Please provide these 4 inputs:\n"
                                 "* hERG IC50 (nM)\n"
                                 "* Na IC50 (nM)\n"
                                 "* CaL IC50 (nM)\n"
        ...
        ApPredictMethods(true);  // Use Grandi model, record APD90 and do Torsade Predictions.
    }
