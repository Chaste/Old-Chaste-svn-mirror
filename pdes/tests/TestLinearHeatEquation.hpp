...
public:
	void TestLinearHeatEquationPdeMethod()
	{
		...
		MatrixDouble diff1 = heat_equation1.ComputeDiffusionTerm(zero1);
		MatrixDouble diff2 = heat_equation2.ComputeDiffusionTerm(zero2);
		MatrixDouble diff3 = heat_equation3.ComputeDiffusionTerm(zero3);
