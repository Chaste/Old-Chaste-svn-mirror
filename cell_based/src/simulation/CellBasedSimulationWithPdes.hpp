...
private:
    ...
    /**
     * Type of mesh to use for the coarse mesh (see /mesh/test/data).
     * Currently only available for 2d meshes.
     * Defaults to zero in the constructor.
     *
     ...
     * 3 - disk_984_elements
     * 
     * @param type the type of coarse mesh
     */
