...
*/
#ifndef LABELLEDCELLMUTATIONSTATE_HPP_
#define LABELLEDCELLMUTATIONSTATE_HPP_
...
CHASTE_CLASS_EXPORT(LabelledCellMutationState)

#endif /* LABELLEDCELLMUTATIONSTATE_HPP_ */
