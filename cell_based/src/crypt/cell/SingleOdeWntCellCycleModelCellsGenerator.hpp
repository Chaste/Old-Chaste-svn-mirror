...
*/
#ifndef SINGLEODEWNTCELLCYCLEMODELCELLSGENERATOR_HPP_
#define SINGLEODEWNTCELLCYCLEMODELCELLSGENERATOR_HPP_
...
class SingleOdeWntCellCycleModelCellsGenerator : public AbstractCellsGenerator<DIM>
{
public :

    /**
     * @return a pointer to a new WntCellCycleModel.
     */
...
#endif /*SINGLEODEWNTCELLCYCLEMODELCELLSGENERATOR_HPP_*/
