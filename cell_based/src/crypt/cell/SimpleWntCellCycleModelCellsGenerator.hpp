...
*/
#ifndef SIMPLEWNTCELLCYCLEMODELCELLSGENERATOR_HPP_
#define SIMPLEWNTCELLCYCLEMODELCELLSGENERATOR_HPP_
...
class SimpleWntCellCycleModelCellsGenerator : public AbstractCellsGenerator<DIM>
{
public :
