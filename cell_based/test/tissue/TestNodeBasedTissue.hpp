...
public:
    ...
    void TestValidateNodeBasedTissue()
    {
        ...
        TS_ASSERT_THROWS_THIS(tissue.Update(),
                "NodeBasedTissue cannot create boxes if the cut-off length has not been set - Call UseCutoffPoint() on the force law, or SetMeinekeMechanicsCutOffLength on TissueConfig");

        TissueConfig::Instance()->SetMeinekeMechanicsCutOffLength(1.2);
        tissue.Update();
    ...
    void TestAddCell()
    {
        ...
        TissueCellPtr p_cell0(new TissueCell(p_state, p_model0));
        ...
        TissueCellPtr p_cell1(new TissueCell(p_state, p_model1));
        ...
        TissueCellPtr p_cell2(new TissueCell(p_state, p_model2));
        ...
        node_based_tissue.AddCell(p_cell2, cell2_location);
    }
    ...
    void TestSetNodeAndAddCell()
    {
        ...
        node_based_tissue.GetCellUsingLocationIndex(0)->Kill();
        ...
        node_based_tissue.AddCell(p_cell, new_cell_location);
        ...
        TissueCellPtr& new_cell = node_based_tissue.rGetCells().back();
    ...
    void TestAddAndRemoveAndAddWithOutRemovingDeletedNodes()
    {
        ...
        node_based_tissue.AddCell(p_new_cell, new_location);
        ...
        node_based_tissue.AddCell(p_new_cell2, new_location2);
    ...
    void TestNodeBasedTissueOutputWriters()
    {
        ...
        boost::shared_ptr<AbstractCellMutationState> p_state = boost::dynamic_pointer_cast<AbstractCellMutationState>(node_based_tissue.GetCellPropertyRegistry()->Get<WildTypeCellMutationState>());
        boost::shared_ptr<AbstractCellMutationState> p_apc1 = boost::dynamic_pointer_cast<AbstractCellMutationState>(node_based_tissue.GetCellPropertyRegistry()->Get<ApcOneHitCellMutationState>());
        boost::shared_ptr<AbstractCellMutationState> p_apc2 = boost::dynamic_pointer_cast<AbstractCellMutationState>(node_based_tissue.GetCellPropertyRegistry()->Get<ApcTwoHitCellMutationState>());
        boost::shared_ptr<AbstractCellMutationState> p_bcat1 = boost::dynamic_pointer_cast<AbstractCellMutationState>(node_based_tissue.GetCellPropertyRegistry()->Get<BetaCateninOneHitCellMutationState>());
        boost::shared_ptr<AbstractCellMutationState> p_apoptotic_state = boost::dynamic_pointer_cast<AbstractCellMutationState>(node_based_tissue.GetCellPropertyRegistry()->Get<ApoptoticCellMutationState>());
        ...
        node_based_tissue.GetCellUsingLocationIndex(0)->AddCellProperty(p_label);
        node_based_tissue.GetCellUsingLocationIndex(1)->GetCellCycleModel()->SetCellProliferativeType(DIFFERENTIATED);
        ...
        TS_ASSERT_EQUALS(system(("diff " + results_dir + "results.viznodes     cell_based/test/data/TestNodeBasedTissueWriters/results.viznodes").c_str()), 0);
        TS_ASSERT_EQUALS(system(("diff " + results_dir + "results.vizcelltypes     cell_based/test/data/TestNodeBasedTissueWriters/results.vizcelltypes").c_str()), 0);
        TS_ASSERT_EQUALS(system(("diff " + results_dir + "results.vizancestors     cell_based/test/data/TestNodeBasedTissueWriters/results.vizancestors").c_str()), 0);
        TS_ASSERT_EQUALS(system(("diff " + results_dir + "cellmutationstates.dat     cell_based/test/data/TestNodeBasedTissueWriters/cellmutationstates.dat").c_str()), 0);
