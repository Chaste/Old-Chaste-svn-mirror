...
//#endif //CHASTE_VTK
    ...
    void TestOutputCellVelocities() throw (Exception)
    {
        ...
        NumericFileComparison cell_velocities(cell_velocities_file, "cell_based/test/data/TestOutputCellVelocities/cellvelocities.dat");
    ...
    void TestStandardResultForArchivingTestsBelow() throw (Exception)
    {
        ...
        NumericFileComparison comp(results_file, "cell_based/test/data/CaBasedCellCyclePhaseOutput/cellcyclephases.dat");
        TS_ASSERT(comp.CompareFiles());
        TS_ASSERT_EQUALS(system(("diff " + results_file + " cell_based/test/data/CaBasedCellCyclePhaseOutput/cellcyclephases.dat").c_str()), 0);
    }
    ...
    void TestExceptions() throw (Exception)
    {
        ...
        TS_ASSERT_EQUALS(system(("diff " + results_dir + "ca_simulation_results.parameters  cell_based/test/data/TestCaSimulationOutputParameters/ca_simulation_results.parameters").c_str()), 0);
    }
};
