...
private:
    ...
    void CheckValuesAreTheDefaultValues()
    {
        ...
        TS_ASSERT_DELTA(p_inst->GetNagaiHondaDeformationEnergyParameter(), 100.0, 1e-12);
        TS_ASSERT_DELTA(p_inst->GetNagaiHondaMembraneSurfaceEnergyParameter(), 10.0, 1e-12);
        TS_ASSERT_DELTA(p_inst->GetNagaiHondaCellCellAdhesionEnergyParameter(), 1.0, 1e-12);
        TS_ASSERT_DELTA(p_inst->GetNagaiHondaCellBoundaryAdhesionEnergyParameter(), 1.0, 1e-12);
        TS_ASSERT_DELTA(p_inst->GetWelikyOsterAreaParameter(), 1.0, 1e-12);
        TS_ASSERT_DELTA(p_inst->GetWelikyOsterPerimeterParameter(), 1.0, 1e-12);
...
public:
    ...
    void TestReset()
    {
        ...
        p_inst->SetNagaiHondaDeformationEnergyParameter(5.8);
        p_inst->SetNagaiHondaMembraneSurfaceEnergyParameter(17.9);
        p_inst->SetNagaiHondaCellCellAdhesionEnergyParameter(0.5);
        p_inst->SetNagaiHondaCellBoundaryAdhesionEnergyParameter(0.6);
        p_inst->SetWelikyOsterAreaParameter(0.7);
        p_inst->SetWelikyOsterPerimeterParameter(0.8);
    ...
    void TestGettersAndSetters()
    {
        ...
        p_inst1->SetNagaiHondaDeformationEnergyParameter(5.8);
        p_inst1->SetNagaiHondaMembraneSurfaceEnergyParameter(17.9);
        p_inst1->SetNagaiHondaCellCellAdhesionEnergyParameter(0.5);
        p_inst1->SetNagaiHondaCellBoundaryAdhesionEnergyParameter(0.6);
        ...
        TS_ASSERT_DELTA(p_inst2->GetNagaiHondaDeformationEnergyParameter(), 5.8, 1e-12);
        TS_ASSERT_DELTA(p_inst2->GetNagaiHondaMembraneSurfaceEnergyParameter(), 17.9, 1e-12);
        TS_ASSERT_DELTA(p_inst2->GetNagaiHondaCellCellAdhesionEnergyParameter(), 0.5, 1e-12);
        TS_ASSERT_DELTA(p_inst2->GetNagaiHondaCellBoundaryAdhesionEnergyParameter(), 0.6, 1e-12);
        TS_ASSERT_DELTA(p_inst2->GetWelikyOsterAreaParameter(), 0.7, 1e-12);
        TS_ASSERT_DELTA(p_inst2->GetWelikyOsterPerimeterParameter(), 0.8, 1e-12);
    ...
    void TestArchiveTissueConfig()
    {
...

        {
            ...
            p_inst1->SetNagaiHondaDeformationEnergyParameter(100.0);
            p_inst1->SetNagaiHondaMembraneSurfaceEnergyParameter(10.0);
            p_inst1->SetNagaiHondaCellCellAdhesionEnergyParameter(1.0);
            p_inst1->SetNagaiHondaCellBoundaryAdhesionEnergyParameter(1.0);
            ...
            TS_ASSERT_DELTA(p_inst1->GetNagaiHondaDeformationEnergyParameter(), 5.8, 1e-12);
            TS_ASSERT_DELTA(p_inst1->GetNagaiHondaMembraneSurfaceEnergyParameter(), 17.9, 1e-12);
            TS_ASSERT_DELTA(p_inst1->GetNagaiHondaCellCellAdhesionEnergyParameter(), 0.5, 1e-12);
            TS_ASSERT_DELTA(p_inst1->GetNagaiHondaCellBoundaryAdhesionEnergyParameter(), 0.6, 1e-12);
