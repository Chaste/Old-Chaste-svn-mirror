 ...
 * human breast cancer mutant; for further deails on this mutant, see for
 ...
 * 
 * As you can see, apart from a serialize() method and a constructor, this class
...
{
private:
    /* The next block of code allows you to archive (save or load) the cell mutation
...
public:
    ...
    void TestP53GainOfFunctionCellMutationState() throw(Exception)
    {
         ...
         * to share a pointer to the same mutation state object (although strictly speaking,
