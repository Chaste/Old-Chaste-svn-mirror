...
CxxTest::StaticSuiteDescription suiteDescription_TestAbstractOdeSystem( "odes/tests/TestAbstractOdeSystem.hpp", 18, "TestAbstractOdeSystem", suite_TestAbstractOdeSystem, Tests_TestAbstractOdeSystem );

static class TestDescription_TestAbstractOdeSystem_testAddition : public CxxTest::RealTestDescription {
public:
 TestDescription_TestAbstractOdeSystem_testAddition() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 31, "testAddition" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_testPetsc() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 38, "testPetsc" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_TestMyAbstractOdeSystem() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 68, "TestMyAbstractOdeSystem" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_TestOdeOne() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 93, "TestOdeOne" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_TestOdeTwo() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 113, "TestOdeTwo" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_TestOdeThree() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 128, "TestOdeThree" ) {}
