...
CxxTest::StaticSuiteDescription suiteDescription_TestAbstractOdeSystem( "odes/tests/TestAbstractOdeSystem.hpp", 13, "TestAbstractOdeSystem", suite_TestAbstractOdeSystem, Tests_TestAbstractOdeSystem );

static class TestDescription_TestAbstractOdeSystem_testAddition : public CxxTest::RealTestDescription {
public:
 TestDescription_TestAbstractOdeSystem_testAddition() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 26, "testAddition" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_testPetsc() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 31, "testPetsc" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_TestMyAbstractOdeSystem() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 61, "TestMyAbstractOdeSystem" ) {}
...
public:
 TestDescription_TestAbstractOdeSystem_TestOdeOne() : CxxTest::RealTestDescription( Tests_TestAbstractOdeSystem, suiteDescription_TestAbstractOdeSystem, 86, "TestOdeOne" ) {}
