...
VertexMesh<2,2>* HoneycombMutableVertexMeshGenerator::GetMesh()
{
    EXCEPTION("A mutable mesh was created but a normal mesh is being requested.");
    return mpMesh; //Not really
}

MutableVertexMesh<2,2>* HoneycombMutableVertexMeshGenerator::GetMutableMesh()
{
    return (MutableVertexMesh<2,2>*) mpMesh;
}
