...
public:
    ...
    void todoTestRawTetgenLibraryCall()
    {
        ///\todo #1545
        ...
        tetgen::tetrahedralize((char*)"pq1.414a0.1", &in, &out);
    



        TS_ASSERT_EQUALS(out.numberofpoints,         324);
        TS_ASSERT_EQUALS(out.numberofpointattributes,    0);
     // TS_ASSERT_EQUALS(out.numberoftriangles,        4);
        TS_ASSERT_EQUALS(out.numberofcorners,        4);
     // TS_ASSERT_EQUALS(out.numberoftriangleattributes, 0);
        TS_ASSERT_EQUALS(out.numberofedges,          0);

        // Free all allocated arrays, including those allocated by Tetgen
//        free(in.pointlist);
//
//        free(out.pointlist);
//        free(out.pointattributelist);
