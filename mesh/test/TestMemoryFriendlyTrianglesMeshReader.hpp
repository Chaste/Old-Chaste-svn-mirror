...
// TestMemoryFriendlyTrianglesMeshReader.hpp

/**
 * Test suite for the MemoryFriendlyTrianglesMeshReader class.
 *
 */

#ifndef _TESTMEMORYFRIENDLYTRIANGLESMESHREADER_HPP_
#define _TESTMEMORYFRIENDLYTRIANGLESMESHREADER_HPP_
...
typedef MemoryFriendlyTrianglesMeshReader<1,1> READER_1D;
typedef MemoryFriendlyTrianglesMeshReader<2,2> READER_2D;
typedef MemoryFriendlyTrianglesMeshReader<3,3> READER_3D;
typedef MemoryFriendlyTrianglesMeshReader<0,1> READER_0D_IN_1D;


class TestMemoryFriendlyTrianglesMeshReader : public CxxTest::TestSuite
{
public:
    ...
    {
        MemoryFriendlyTrianglesMeshReader<2,2> *p_mesh_reader;
    ...
    {
        MemoryFriendlyTrianglesMeshReader<2,2> *p_mesh_reader;
        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<2,2>(
    ...
    {
        MemoryFriendlyTrianglesMeshReader<3,3> *p_mesh_reader;
    ...
    {
        MemoryFriendlyTrianglesMeshReader<2,2> reader("mesh/test/data/baddata/permuted_nodes_disk_522_elements");
    ...
    {
        MemoryFriendlyTrianglesMeshReader<2,2> *p_mesh_reader;
        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<2,2>("mesh/test/data/disk_984_elements");
    ...
    {
        MemoryFriendlyTrianglesMeshReader<1,1> *p_mesh_reader;
        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<1,1>("mesh/test/data/trivial_1d_mesh");
    ...
    {
        MemoryFriendlyTrianglesMeshReader<0,1> *p_mesh_reader;
    ...
    {
        MemoryFriendlyTrianglesMeshReader<1,2> *p_mesh_reader;

        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<1,2>("mesh/test/data/circle_outline");
        ...
        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<1,2>("mesh/test/data/semicircle_outline");
    ...
    {
        MemoryFriendlyTrianglesMeshReader<2,3> *p_mesh_reader;

        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<2,3>("mesh/test/data/slab_395_elements");
        ...
        p_mesh_reader=new MemoryFriendlyTrianglesMeshReader<2,3>("mesh/test/data/disk_in_3d");
    ...
    void TestReadingQuadraticMesh1d() throw(Exception)
    {
        ...
        MemoryFriendlyTrianglesMeshReader<1,1> mesh_reader("mesh/test/data/1D_0_to_1_10_elements_quadratic", 2);
    ...
    {
        MemoryFriendlyTrianglesMeshReader<2,2> mesh_reader("mesh/test/data/square_128_elements_quadratic", 2);
    ...
    {
        MemoryFriendlyTrianglesMeshReader<3,3> mesh_reader("mesh/test/data/3D_Single_tetrahedron_element_quadratic", 2);
...
#endif //_TESTMEMORYFRIENDLYTRIANGLESMESHREADER_HPP_
