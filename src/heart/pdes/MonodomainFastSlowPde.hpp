...
class MonodomainFastSlowPde : public AbstractCardiacFastSlowPde<DIM>, public MonodomainPde<DIM>
{
friend class TestCardiacFastSlowPde;

public:
    /** Note: we have MonodomainFastSlowPde inheriting from both AbstractCardiacFastSlowPde and
     * MonodomainPde, both of which inherit from AbstractCardiacPde (a 'dreaded diamond'). Therefore,
